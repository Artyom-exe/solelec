...
const formData = reactive({
    ...
    description: "",
    desiredDate: [], // Tableau pour [date début, date fin]
    name: "",
    phone: "",
    email: "",
    address: "",
...
<template>
    ...
    >
        ...
        <div
            class="flex-1 overflow-y-auto p-6 rounded-t-lg"
            :class="{
        ...
        >
            ...
            <div v-if="step === 1" class="flex flex-col gap-6">
                <h3 class="text-[#0D0703] font-medium text-2xl font-poppins">
                    Je désire :
                </h3>
            ...
            <!-- Étape 2 : Description du projet + Datepicker -->
            <div v-else-if="step === 2" class="flex flex-col gap-6 h-max">
                <h3 class="text-[#ffff] font-medium text-2xl font-poppins">
                    Dites m'en plus :
                </h3>
                <textarea
...
/* Transition du contenu : scale & fade */
