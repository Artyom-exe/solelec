...
<template>
  <article class="flex flex-col gap-8 py-16 px-4 md:px-8 lg:px-16 bg-[#F5F5F5]" data-aos="fade-up" data-aos-duration="800">
    ...
    <div class="flex flex-col md:flex-row gap-8">
      <!-- Deux colonnes -->
      <div class="grid grid-cols-2 gap-6 md:w-1/2" data-aos="fade-right" data-aos-delay="100" data-aos-duration="800">
        <button
      ...
      <!-- Carte -->
      <div class="md:w-1/2 h-[440px] rounded-lg overflow-hidden shadow" data-aos="zoom-in" data-aos-delay="300" data-aos-duration="1000">
