...
<template>
    <nav
        class="flex fixed top-0 left-0 right-0 bg-[#2D2D2D] md:px-16 px-5 justify-center flex-col items-center md:h-[72px] h-[66px] z-50"
    >
        <div
            class="flex justify-between items-center md:gap-8 self-stretch w-full max-w-screen-2xl mx-auto"
        >
            <!-- Logo -->
            <Link
                href="/admin"
            ...
            >
                <div class="flex flex-col space-y-6 mt-4">
                    ...
                    <div class="space-y-4 border-t border-gray-200 pt-4">
                        ...
                        <Link
                            :href="route('profile.admin')"
                            class="flex items-center space-x-3 text-gray-700 py-2 hover:text-[#FF8C42] transition-colors duration-200 w-full text-left"
                            @click="toggleMobileMenu"
                        >
                            <svg
                                class="w-5 h-5"
