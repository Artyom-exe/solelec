...
<template>
    <nav class="fixed top-0 left-0 right-0 bg-[#2D2D2D] px-16 justify-center flex-col items-center py-4 z-50">
            ...
            <div class="hidden md:flex items-center space-x-8">
                <div class="flex space-x-6">
                    ...
                    <div class="relative about-dropdown">
                        ...
                        >
                            <template v-for="item in aboutSubItems" :key="item.name">
                                <!-- Si on est sur la page d'accueil, utiliser juste l'ancre -->
                                <a
                                    v-if="isHomePage()"
                                    :href="item.anchor"
                                ...
                                <!-- Sinon, lien vers la page d'accueil avec ancre -->
                                <Link
                                    v-else
        ...
        <div v-if="mobileMenuOpen" class="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg py-4 px-6">
            <div class="flex flex-col space-y-4">
                ...
                <div class="py-2">
                    <div class="font-inter text-gray-700 font-medium">À propos</div>
                ...
                <PrimaryButton class="w-full justify-center" @click="toggleMobileMenu">
                    Demander un devis
                </PrimaryButton>
            </div>
        </div>
