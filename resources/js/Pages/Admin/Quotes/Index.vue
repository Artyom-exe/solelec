...
<template>
    <AdminLayout>
        <section
            class="flex md:flex-row flex-col md:py-28 md:px-16 py-16 px-5 items-start bg-[#2D2D2D] md:mt-[72px] mt-16 min-h-screen"
        >
            <div
                class="w-full max-w-screen-2xl mx-auto md:gap-20 gap-12 md:flex-row flex-col flex"
            >
                <div
                    class="flex flex-col items-start gap-4 text-white md:w-3/4"
                >
