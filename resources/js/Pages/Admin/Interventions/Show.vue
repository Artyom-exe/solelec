            ...
            <div class="container flex items-start gap-20 self-stretch">
                ...
                <div class="flex min-w-[464px] flex-col items-start gap-8">
                    ...
                    <div class="flex items-start gap-8 w-full">
                        <a
                            v-if="intervention.client.phone"
                            :href="`tel:${intervention.client.phone}`"
                            class="font-inter w-1/2 flex-col items-start text-[#FF8C42] text-base font-normal hover:text-white transition-colors cursor-pointer flex gap-2"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                        ...
                        <a
                            v-if="intervention.client.email"
                            :href="`mailto:${intervention.client.email}`"
                            class="font-inter w-1/2 flex-col items-start text-white text-base font-normal hover:text-[#FF8C42] transition-colors cursor-pointer flex gap-2"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="22"
                    ...
                    <div class="flex items-start gap-8">
                        <a
                            v-if="intervention.client.adress"
                            :href="`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(
                                intervention.client.adress
                            )}`"
                            target="_blank"
                            rel="noopener"
                            class="font-inter flex-col items-start text-blue-300 text-base font-normal hover:text-[#FF8C42] transition-colors cursor-pointer flex gap-2"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="22"
