                ...
                <div class="flex min-w-[464px] flex-col items-start gap-8">
                    <div class="flex w-full gap-8">
                        ...
                        <div class="flex flex-col gap-2 items-start w-1/2">
                            ...
                            <span class="font-inter text-base font-normal">
                                <span :class="{'text-gray-400': !intervention.devis.requested_date}">{{ intervention.devis.requested_date ? formatDate(intervention.devis.requested_date) : "Non renseigné" }}</span>
                                -
                                <span :class="{'text-gray-400': !intervention.devis.end_date}">{{ intervention.devis.end_date ? formatDate(intervention.devis.end_date) : "Non renseigné" }}</span></span
                            >
                        </div>
                    </div>
                    <div class="flex items-start gap-8 w-full">
                        <div class="font-inter w-1/2 flex-col items-start text-base font-normal flex gap-2">
                            <a
                                :href="intervention.client.phone ? `tel:${intervention.client.phone}` : '#'"
                                :class="intervention.client.phone ? 'text-[#FF8C42] hover:text-white transition-colors cursor-pointer flex gap-2 items-start flex-col' : 'text-gray-400 flex gap-2 items-start flex-col'"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                ...
                                {{ intervention.client.phone ? intervention.client.phone : "Non renseigné" }}
                            </a>
                        </div>
                        <div class="font-inter w-1/2 flex-col items-start text-base font-normal flex gap-2">
                            <a
                                :href="intervention.client.email ? `mailto:${intervention.client.email}` : '#'"
                                :class="intervention.client.email ? 'text-white hover:text-[#FF8C42] transition-colors cursor-pointer flex gap-2 items-start flex-col' : 'text-gray-400 flex gap-2 items-start flex-col '"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                ...
                                {{ intervention.client.email ? intervention.client.email : "Non renseigné" }}
                            </a>
                        </div>
                    </div>
                    <div class="flex items-start gap-8 w-full">
                        <div class="font-inter flex-col items-start text-base font-normal flex gap-2 w-full">
                            <a
                                :href="intervention.client.adress ? `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(intervention.client.adress)}` : '#'"
                                :target="intervention.client.adress ? '_blank' : ''"
                                :rel="intervention.client.adress ? 'noopener' : ''"
                                :class="intervention.client.adress ? 'text-blue-300 hover:text-[#FF8C42] transition-colors cursor-pointer flex gap-2 items-start flex-col' : 'text-gray-400 flex gap-2 items-start flex-col'"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                ...
                                {{ intervention.client.adress ? intervention.client.adress : "Non renseigné" }}
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-2 mt-4">
                            <div class="flex">
                                ...
                                <span class="text-sm ml-2">{{
                                    devisDetails?.vehicleType || "Tesla Model 3"
                                }}</span>
                            </div>
                            <div class="flex">
                                <span class="text-sm font-semibold"
                                    >• Prestation souhaitée:</span
                                >
                                <span class="text-sm ml-2">{{
                                    devisDetails?.prestationDuration || "15 min"
                                }}</span>
                            </div>
                            <div class="flex">
                                <span class="text-sm font-semibold"
                            ...
                            <div class="flex">
                                <span class="text-sm font-semibold"
                                    >• Distance au tableau électrique:</span
                                >
                                <span class="text-sm ml-2">{{
                                    devisDetails?.electricalPanel ||
                                    "Environ 8 mètres"
                                }}</span>
                            </div>
                        </div>
