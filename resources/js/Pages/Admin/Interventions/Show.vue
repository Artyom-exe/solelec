...
<template>
    <AdminLayout>
                            ...
                            <div class="relative service-group">
                                ...
                                >
                                    ...
                                    <span
                                        v-if="
                                            intervention.devis?.services &&
                                            intervention.devis.services.length >
                                                1
                                        "
                                        class="ml-1"
                                    >
        ...
        <main class="w-full max-w-full">
            ...
            <section class="md:py-28 py-16 md:px-16 px-5 flex-wrap">
                <div
                    class="flex md:gap-20 gap-12 w-full max-w-screen-2xl mx-auto content-center items-start flex-wrap"
                >
            ...
            <!-- Photos -->
            <section
                class="flex md:py-28 py-16 md:px-16 px-5 flex-col bg-[#2D2D2D] w-screen"
            >
                <div
                    class="flex w-full max-w-screen-2xl mx-auto md:gap-20 gap-12 flex-col content-center items-start"
                >
                    <div
                    ...
                    <div
                        ...
                        "
                        :class="
                            isMobile ? 'w-full' : 'w-screen -mx-16 relative'
                        "
                    >
            ...
            <!-- Notes -->
            <section class="w-full md:py-28 py-16 md:px-16 px-5 flex flex-col">
                <div
                    ...
                    <div style="width: 100%; max-width: 100%; display: block">
                        ...
                        >
                            ...
                            <p class="text-sm text-[#FF8C42] mt-2">
                                Utilisez le formulaire ci-dessus pour ajouter
                                des notes
                            </p>
                        </div>
                    </div>
