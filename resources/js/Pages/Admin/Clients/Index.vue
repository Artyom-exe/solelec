        ...
        >
            <div class="flex md:flex-row flex-col justify-between self-stretch">
                ...
                <div class="flex items-end">
                    <PrimaryButton
                        ...
                        class="h-max"
                    >
                        {{ isCreatingClient ? "Annuler" : "Ajouter" }}
                    </PrimaryButton>
                </div>
            </div>
            ...
            <transition name="fade">
                <div
                    ...
                    class="client-card flex flex-col md:flex-row items-center gap-6 md:gap-8 w-full md:w-[calc(50%-1.5rem)] relative"
                >
                    ...
                    <!-- Version mobile : bande colorée à gauche + formulaire -->
                    <div
                        class="md:hidden flex w-full relative bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border-l-4 border-r border-t border-b border-r-gray-700/50 border-t-gray-700/50 border-b-gray-700/50"
                        :style="{
                            'border-left-color': newClientColor,
                        }"
                    >
                    ...
                    <!-- Version desktop : formulaire classique -->
                    <div
                        class="hidden md:flex flex-col items-start gap-2 w-full md:w-1/2"
                    >
                        <div
